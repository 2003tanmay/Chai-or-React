...
const AddTodo = () => {
    ...
    return (
        <form onSubmit={addTodoHandler} className="space-x-3 mt-12 mb-5 w-full flex justify-center">
            <input
                type="text"
            ...
            <button
                type="submit"
                className="w-[15%] text-white bg-indigo-500 border-0 py-2 focus:outline-none hover:bg-indigo-600 rounded text-lg"
            >
                Add Todo
            </button>
        </form>
